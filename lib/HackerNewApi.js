...
HackerNewsApi.prototype = {
    ...
    _isPartTime: function (text) {
        return !!(text.match(/part\s?time/i) || []).length;
    },
    ...
    //_matchSkill: function (text) {
    //    var skills = {
    //        developer: !!(text.match(/developer/i) || []).length,
    //        sysadmin: !!(text.match(/sysadmin/i) || !!(text.match(/systems\sadministrators?/i) || []).length),
    //        csharp: !!(text.match(/c#/i) || []).length,
    //        cplusplus: !!(text.match(/c\/+\/+/i) || []).length,
    //        security: !!(text.match(/security/i) || []).length,
    //        networking: !!(text.match(/networking/i) || []).length
    //
    //    };
    //    return skills;
    //},
